...
/**
 * Created by pcban on 29 Apr 2017.
 */
...
public class JSONParser {
    ...
    public void runQuery(String url, List<NameValuePair> params) {
        try {
            // defaultHttpClient
    ...
    public JSONObject postJSONFromUrl(String url, ArrayList<NameValuePair> nameValuePairs){
        try{
            DefaultHttpClient httpClient = new DefaultHttpClient();
            HttpPost httpPost = new HttpPost(url);
