...
{
    Context context;
    List<com.example.pcban.omsap.OrgProposals.ReservedRooms> ReservedRooms;

    public MyReservedRoomsCardView (List<com.example.pcban.omsap.OrgProposals.ReservedRooms> getDataAdapter, Context context)
    {
        super();
    ...
    {
        com.example.pcban.omsap.OrgProposals.ReservedRooms getDataAdapter1 =  ReservedRooms.get(position);
        holder.room.setText(getDataAdapter1.getRoomNum());
